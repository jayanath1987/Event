...
@Component
@Scope("view")
public class ResendInvitaionsView extends AbstractView {

	private final static Logger logger = Logger.getLogger(ResendInvitaionsView.class);
